...
from AbhiModszYT import AMBOT
from AbhiModszYT.modules.helpers import CHATBOT_ON, is_admins
            ...
            if not is_vick:
                ...
                if k:
                    ...
                    if Yo == "sticker":
                        ...
                        await message.reply_text(f"{hey}")
        elif message.reply_to_message.from_user and message.reply_to_message.from_user.id != client.id:
            if message.sticker:
...
# The following is assumed to be in config.py or directly in your main script
